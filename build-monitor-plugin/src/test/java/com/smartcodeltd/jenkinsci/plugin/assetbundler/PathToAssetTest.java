...
public class PathToAssetTest {
    ...
    public void combines_base_resource_url_given_by_jenkins_and_a_path_to_the_asset() throws Exception {
        ...
        URL base = baseResourceUrlGivenByJenkins("file:///c:\\opt\\jenkins\\plugins\\build-monitor-plugin\\");
        ...
        assertThat(absolute(path), is("c:\\opt\\jenkins\\plugins\\build-monitor-plugin\\less\\index.less"));
    }
    ...
    public void works_with_unc_paths_on_windows() throws Exception {
        ...
        URL base = baseResourceUrlGivenByJenkins("file:\\C:\\server\\jenkins\\plugins\\build-monitor-plugin\\");

        PathToAsset path = new PathToAsset(base, "less/index.less");

        assertThat(absolute(path), is("C:\\server\\jenkins\\plugins\\build-monitor-plugin\\less\\index.less"));
